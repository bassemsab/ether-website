...
export const handle: Handle = async ({ event, resolve }) => {
  ...
  if (
    ...
    try {
      ...
      return new Response(
        `<!DOCTYPE html><html><head><meta http-equiv="refresh" content="1"><title>Mise à jour de l'aperçu...</title><style>body{font-family:-apple-system,BlinkMacSystemFont,sans-serif;display:flex;align-items:center;justify-content:center;height:100vh;background:#FBF9F5;color:#1E1B39;margin:0;}.box{text-align:center;padding:24px 32px;background:#fff;border:1.5px solid #1E1B39;border-radius:16px;box-shadow:3px 3px 0 #1E1B39;}</style></head><body><div class="box"><h3>⚡ Mise à jour de l'aperçu...</h3><p style="font-size:12px;color:#666;margin:8px 0 0 0;">Le serveur applique les modifications. Reconnexion automatique...</p></div><script>setTimeout(function(){try{window.location.reload();}catch(e){}},1000);</script></body></html>`,
        {
          status: 200,
          headers: {
