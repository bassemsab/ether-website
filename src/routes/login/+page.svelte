...
<div class="min-h-screen flex flex-col items-center justify-center bg-background text-foreground px-4 py-12 grain-overlay">
  ...
  <div class="retro-card w-full max-w-md p-8 md:p-10 space-y-6">
    ...
    <a
      href="/auth/github"
      class="focus-ring inline-flex w-full items-center justify-center gap-3 rounded-full border border-black/10 bg-surface/80 px-6 py-3 text-xs uppercase tracking-[0.2em] text-foreground backdrop-blur-md transition-all duration-300 hover:border-black/20 hover:bg-surface"
    >
